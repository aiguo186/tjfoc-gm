...
```bash
go get -u github.com/aiguo186/tjfoc-gm
```
...
- go package： `github.com/aiguo186/tjfoc-gm/sm2`
...
- g package：`github.com/aiguo186/tjfoc-gm/sm3`
...
- go package：`github.com/aiguo186/tjfoc-gm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/aiguo186/tjfoc-gm/sm4"
    import "fmt"
...
### 具体功能测试代码参考
```Go
github.com/aiguo186/tjfoc-gm/sm2/sm2_test.go  //sm2算法
github.com/aiguo186/tjfoc-gm/sm3/sm3_test.go  //sm3算法
github.com/aiguo186/tjfoc-gm/sm4/sm4_test.go  //sm4算法
github.com/aiguo186/tjfoc-gm/x509/x509_test.go //x509国密证书
github.com/aiguo186/tjfoc-gm/gmtls/gmcredentials/credentials_test.go  //国密tls
github.com/aiguo186/tjfoc-gm/gmtls/gmcredentials/websvr/websvr.go     //国密tls与非国密TLS自适应
```
